...
router.patch('/:id').get(protect, restrictTo('admin', 'lead-guide', 'guide'),
    controllers.updateTour
);


//* note: in this route i have 3 params [distance, latlng, & unit]
router.route('/tours-within/:distance/center/:latlng/unit/:unit').get(controllers.getToursWithin)
//* this is equivalent => tours-distance?distance=233&center=-40,45&unit=mi
//* this is equivalent => tours-distance/233/center/-40,45/unit/mi
...
router
    ...
    .post(protect, restrictTo('admin', 'lead-guide'),
        uploadTourImages,
        resizeTourImages,
...
router
    .route('/:id')
    .patch(protect, restrictTo('admin', 'lead-guide'),
        uploadTourImages,
        resizeTourImages,
        controllers.updateTour
    )
