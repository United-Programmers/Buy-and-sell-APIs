...
const { getAll, getOne, updateOne, deleteOne, geSuspended, getActive, getUnverified, getStudents, getTutors } = require('./handleFactory');
const { Suspended, UnSuspended, Approved, Declined } = require('../utils/verifyEmail')
...
exports.updateMe = catchAsync(async (req, res, next) => {
    ...
    const filteredBody = filterObj(req.body, 'firstName', 'lastName', 'phoneNumber', 'email', 'photo');
