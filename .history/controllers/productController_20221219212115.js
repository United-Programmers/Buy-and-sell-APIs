...
//         'startDates',
//         'name', 'gender', 'price', 'duration',
//         'maxGroupSize', 'difficulty', 'priceDiscount', 'summary', 'description',
//         'imageCover', 'images'
//     );

//     if (req.file) filteredBody.imageCover = req.file.filename;
//     if (req.file) filteredBody.images = req.file.filename;

//     const updatedTour = await Tour.findByIdAndUpdate(req.user.id, filteredBody, { new: true, runValidators: true });
